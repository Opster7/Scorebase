...
from sdeNoise import marginal_prob_std_fn, device, EMA, loss_fn
...
if resume:
    if os.path.isfile("checkpointC/ckpt_49.pth"):
        print("Resume from checkpointC...")
        path_checkpoint = "checkpointC/ckpt_49.pth"  # 断点路径
